                    ...
                    <?php if ($isComplete) { ?>
                        <td>
                            ...
                            <?php if ($row->submunicipalityto !== '') { ?>
                                ...
                                <?php echo view('core/link', [
                                    'type' => 'government',
                                    'link' => $row->submunicipalityto,
                                    'text' => $row->submunicipalitytolong
                                ]) ?>
