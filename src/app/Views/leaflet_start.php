...
<script src="/<?= ($online ? '/unpkg.com/maplibre-gl@2.4.0/dist' : 'asset/map') ?>/maplibre-gl.js"></script>
...
<?php if ($state == 'de' or $state == 'ma' or $state == 'nj') /* Version 3.0.10, with forked modifications */ { ?>
