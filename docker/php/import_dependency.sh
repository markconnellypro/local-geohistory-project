...
curl -s -S --output-dir "${asset_folder}/css" "https:/${dependency_datatables}/css/dataTables.dataTables.min.css"
curl -s -S --output-dir "${asset_folder}/js" "https:/${dependency_datatables}/js/dataTables.min.js"
...
curl -s -S --output-dir "${asset_folder}/images" "https:/${dependency_leaflet}/images/layers.png"
curl -s -S --output-dir "${asset_folder}/images" "https:/${dependency_leaflet}/images/marker-icon.png"
curl -s -S --output-dir "${asset_folder}/images" "https:/${dependency_leaflet}/images/marker-shadow.png"
...
curl -s -S --output-dir "${asset_folder}/css" "https:/${dependency_selectize}/css/selectize.css"
curl -s -S --output-dir "${asset_folder}/js/standalone" "https:/${dependency_selectize}/js/standalone/selectize.min.js"
